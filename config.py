...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6779210922:AAFw-7BBGEZSMDEv85qvi8O3IKalkzjbms0")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002089667059"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "Berlin_files")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "830092783 5884953489").split()):
        ADMINS.append(int(x))
except ValueError:
        raise Exception("Your Admins list does not contain valid integers.")

#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>you need to join the following channel to get files\n\nKindly Please join Channel</b>")
